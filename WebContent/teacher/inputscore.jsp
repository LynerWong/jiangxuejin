...
<html>
  <head>
    ...
    <title>My JSP 'inputscore.jsp' starting page</title>
  ...
  <body onload="check(f1)" background="/jiangxuejin1/picture/ll.jpg">
    <p><font size="5"><b>录入学生成绩</b></font></p>
    <form name="f1" action="/jiangxuejin1/InputScore?page=1" method="post">
    <table><tr><td>
    ...
    <tr align="center" ><td><a href="/jiangxuejin1/InputScore?classs=${classy}&&course=${course}&&page=1">首页</a></td>
    <td><a href="/jiangxuejin1/InputScore?classs=${classy}&&course=${course}&&page=${page-1>0? page-1:1}">上   一  页</a></td>
    <td><a href="/jiangxuejin1/InputScore?classs=${classy}&&course=${course}&&page=${page+1<pageCount? page+1:pageCount}">下一页</a></td>
    <td><a href="/jiangxuejin1/InputScore?classs=${classy}&&course=${course}&&page=${pageCount}">尾页</a></td></tr>
    <tr align="center"><td>学号</td><td>姓名</td><td>平时成绩</td><td>期末成绩</td></tr>
    <c:forEach var="xy" items="${info}">
    <tr><td>${xy.sid}</td><td>${xy.sname}</td><td><input type="text" size="15" name="${xy.sid}"/></td><td><input type="text" size="15" name="${xy.sid}"/>
    <input type="hidden" name="sid" value="${xy.sid}"/></td></tr>
    </c:forEach>
    <tr align="center"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
    <tr align="center"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
    <tr><td><input type="hidden" name="setup" value="${ss}"/><input type="submit" value="提    交" /></td>
